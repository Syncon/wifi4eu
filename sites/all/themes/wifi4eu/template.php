 ...
 */
function wifi4eu_theme($existing, $type, $theme, $path) {
  return [
    'wifi4eu_status_message' => [
 ...
 */
// function wifi4eu_preprocess_europa_status_message(&$variables) {
 ...
 */
function wifi4eu_form_views_exposed_form_alter(&$form, &$form_state, $form_id) {
 ...
 */
function wifi4eu_date_popup_process_alter(&$element, &$form_state, $context) {
 ...
 */
function wifi4eu_menu_tree__secondary(&$variables) {
 ...
 */
function wifi4eu_form_element(&$variables) {
...
/**
 * Wrapper function for the last menu.
 *
 * @see theme_menu_tree()
 */
function wifi4eu_menu_tree__menu_footer_last_menu(&$variables) {
  return _wifi4eu_menu_tree_footer($variables['tree'], TRUE);
}
 ...
 * @see theme_menu_tree()
 */
function wifi4eu_menu_tree__menu_european_commission_header(&$variables) {
  return _wifi4eu_menu_tree_footer($variables['tree'], TRUE);
}
 ...
 * @see theme_menu_tree()
 */
function wifi4eu_menu_tree__menu_european_commission_footer(&$variables) {
  return _wifi4eu_menu_tree_footer($variables['tree'], FALSE);
}
 ...
 * @see theme_menu_tree()
 */
function wifi4eu_menu_tree__menu_follow_ec(&$variables) {
  return _wifi4eu_menu_tree_footer($variables['tree'], TRUE);
}
 ...
 * @see theme_menu_tree()
 */
function wifi4eu_menu_tree__menu_european_union(&$variables) {
  return _wifi4eu_menu_tree_footer($variables['tree'], FALSE);
}
 ...
 */
function _wifi4eu_menu_tree_footer($tree, $inline = FALSE) {
 ...
 */
function wifi4eu_menu_link__menu_footer_last_menu(&$variables) {
  return _wifi4eu_menu_link__footer($variables);
}

/**
 * Override theme_menu_link().
 */
function wifi4eu_menu_link__menu_european_commission_footer(&$variables) {
  return _wifi4eu_menu_link__footer($variables);
}
 ...
 *   HTML markup
 */
function _wifi4eu_menu_link__footer(array &$variables) {
  $element = $variables['element'];
  $sub_menu = '';
 ...
 */
function wifi4eu_html_head_alter(&$head_elements) {
  // Creating favicons links and meta tags for the html header.
  $europa_theme_png_path = base_path() . drupal_get_path('theme', 'wifi4eu') . '/images/png/favicon/';
  $elements = [
    [
      '#tag' => 'link',
      '#attributes' => [
 ...
 */
// function wifi4eu_form_nexteuropa_europa_search_search_form_alter(&$form, &$form_state, $form_id) {
 ...
 */
// function _wifi4eu_breadcrumb_menu(&$variables) {
//   global $language;
...
//  */
// function wifi4eu_easy_breadcrumb(&$variables) {
//   if (drupal_is_front_page() && !theme_get_setting('ec_europa_breadcrumb_home')) {
//     return;
//   }

//   _wifi4eu_breadcrumb_menu($variables);
 ...
 */
function wifi4eu_file_link($variables) {
  if (function_exists('_nexteuropa_formatters_file_markup')) {
    ...
    return _wifi4eu_formatters_file_markup($file);
  }
}
 ...
 */
function wifi4eu_preprocess_block(&$variables) {
  $block = $variables['block'];
  $variables['theme_hook_suggestions'][] = 'block__' . $block->module . '__' . str_replace('-', '_', $block->delta) . '_' . $block->region;

  switch ($block->delta) {
    case 'menu-european-commission-footer':
    case 'menu-follow-ec':
    case 'menu-european-union':
      $variables['title'] = '<h4 class="footer__title">' . $block->info . '</h4>';
      break;
    ...
    case 'menu-european-commission-header':
      $block->subject = '';
      break;
  ...
  if (isset($block->bid) && $block->bid === 'language_selector_page-language_selector_page') {
    ...
    drupal_add_js(drupal_get_path('theme', 'wifi4eu') . '/js/selectify.js');
    drupal_add_js(drupal_get_path('theme', 'wifi4eu') . '/js/components/lang-switcher.js');
  ...
  if (theme_get_setting('ec_europa_multilingual', 'wifi4eu')
    && !empty($block->bid)
    && $block->bid === 'language_selector_site-language_selector_site'
  ) {
    // Add the js to make it function.
    drupal_add_js(drupal_get_path('theme', 'wifi4eu') . '/js/components/lang-select-site.js');
  }
    ...
    if (strpos($block->bid, 'views--exp-') !== FALSE
      ...
      if (isset($block->context) && $context = context_load($block->context)) {
        ...
        if (array_search($block->bid, array_keys($context->reactions['block']['blocks'])) === 0) {
          ...
          drupal_add_js(drupal_get_path('theme', 'wifi4eu') . '/js/components/filters.js');
        }
      }
    }
  }
 ...
 */
function wifi4eu_preprocess_bootstrap_fieldgroup_nav(&$variables) {
  drupal_add_js(drupal_get_path('theme', 'wifi4eu') . '/js/libraries/jquery-accessible-tabs.js');
 ...
 */
function wifi4eu_preprocess_field(&$variables) {
 ...
 * it in some cases.
 */
function wifi4eu_preprocess_image(&$variables) {
 ...
 */
function wifi4eu_preprocess_html(&$variables) {
  $this_theme_path = drupal_get_path('theme', 'wifi4eu');
 ...
 */
function wifi4eu_preprocess_node(&$variables) {
 ...
 */
function wifi4eu_preprocess_taxonomy_term(&$variables) {
 ...
 */
function wifi4eu_preprocess_page(&$variables) {
  ...
  $variables['theme_settings'] = [
    'header_home' => theme_get_setting('ec_europa_site_header_home', 'wifi4eu'),
    'improved' => theme_get_setting('ec_europa_improved_website', 'wifi4eu'),
    'improved_header' => theme_get_setting('ec_europa_improved_website_header', 'wifi4eu'),
    'identification_home' => theme_get_setting('ec_europa_improved_website_home', 'wifi4eu'),
  ];
 ...
 */
function _wifi4eu_term_heading($element) {
 ...
 */
function wifi4eu_preprocess_views_view(&$variables) {
 ...
 */
function wifi4eu_pager($variables) {
 ...
 */
function wifi4eu_pager_link($variables) {
  $text = $variables['text'];
 ...
 */
function wifi4eu_pager_first($variables) {
 ...
 */
function wifi4eu_pager_previous($variables) {
  global $pager_page_array;
 ...
 */
function wifi4eu_pager_next($variables) {
  global $pager_page_array, $pager_total;
 ...
 */
function wifi4eu_pager_last($variables) {
  global $pager_page_array, $pager_total;
 ...
 */
function wifi4eu_form_alter(&$form, &$form_state, $form_id) {
 ...
 */
function wifi4eu_status_messages($variables) {
 ...
 * settings instead.
 */
function wifi4eu_file_widget($variables) {
  $output = '';
  $element = $variables['element'];
  ...
  if ($check_use) {
    ...
    $element['upload']['#attached']['js'][] = drupal_get_path('theme', 'wifi4eu') . '/js/components/file-upload.js';
 ...
 */
function wifi4eu_file_upload_help($variables) {
 ...
 */
function wifi4eu_ds_pre_render_alter(&$layout_render_array, $context, &$variables) {
 ...
 */
function wifi4eu_preprocess_comment_wrapper(&$variables) {
 ...
 */
function wifi4eup_reprocess_comment(&$variables) {
